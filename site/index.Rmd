...
This site details the parameterisation of StrathE2E for the Norwegian Shelf, as part of Mission Atlantic. From here you can access different types of documentation.
...
Details the dependencies between the R scripts processing original data sources. The dependencies are updated every time the site is built.
...
Provides links to other StrathE2E implementations as part of Mission Atlantic.
